...
public class UnitStability : MonoBehaviour
{
    /// <summary>
    ...
    public float GetStabilityPerAttackSpeed(int stability)
    {
    ...
    public float GetStabilityPerMoveSpeed(int stability)
    {
        if (0 > stability || 100 < stability) { return -1; }
    ...
    float[] _stabilityPerAttackSpeeds = new float[11];
    float[] _stabilityPerMoveSpeeds = new float[11];
